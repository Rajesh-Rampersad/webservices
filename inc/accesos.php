        ...
        <div class="col-md-12">
            ...
            <div class="page-header">
                ...
                <div class="page-header well well-sm">
                    (!) Primero seleccione el usuario y luego guarde los permisos a los acceso.
                </div>
                
                    <form role="form" class="form-horizontal"  id="formUsuarios">
                            <div class="form-group">
                                <label for="usuario" class="col-md-3 control-label">Usuarios (!)</label>
                            <div class="col-md-9">
                                <select id="usuario" class="form-control" required></select>
                                </div>
                            </div>
                            <div class="form-group">
