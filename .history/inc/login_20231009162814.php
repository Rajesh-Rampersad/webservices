...
<head>
    ...
    <link href="img/system/favicon.ico?v=<?php echo $parametro['webversion']; ?>" rel="icon" type="timage/x-icon" />
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="alert alert-info text-center">
                    Bienvenido al sistema de Pedidos Web.
                </div>
                    ...
                    <div class="panel-body">
                        <form role="form" id="formLogin" class="form-horizontal">
                            <div class="form-group">
                                <label for="usuario" class="col-med-2 control-label">Usuario</label>
                                <div class="col-md-10">
                                    <input type="text" id="usuario" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="contrasena" class="col-med-2 control-label">Contraseña</label>
                                <div class="col-md-10">
